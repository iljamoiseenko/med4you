import template from './sw-cms-el-product-slider-custom.html.twig';
import './sw-cms-el-product-slider-custom.scss';

const { Component, Mixin } = Shopware;

Component.register('sw-cms-el-product-slider-custom', {
    template,
