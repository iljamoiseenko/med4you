import template from './sw-cms-el-config-product-slider-custom.html.twig';
import './sw-cms-el-config-product-slider-custom.scss';

const { Component, Mixin } = Shopware;
const { Criteria, EntityCollection } = Shopware.Data;

Component.register('sw-cms-el-config-product-slider-custom', {
    template,
