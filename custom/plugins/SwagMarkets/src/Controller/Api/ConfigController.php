...
class ConfigController extends AbstractController
{
    ...
    {
        $storeRequestOptionsProvider = new StoreRequestOptionsProvider($this->userRepository, $this->systemConfigService, $this->instanceService, $this->localeProvider);

        $tokenInformation = [
            'url' => $this->systemConfigService->get('core.store.apiUri'),
            'longLifeToken' => $storeRequestOptionsProvider->getAuthenticationHeader($context)['X-Shopware-Platform-Token'],
