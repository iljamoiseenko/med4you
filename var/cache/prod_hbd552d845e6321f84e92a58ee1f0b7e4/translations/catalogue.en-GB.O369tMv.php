...
$catalogue = new MessageCatalogue('en-GB', array (
  ...
  array (
    ...
    'checkout.confirmTermsReminder' => 'You have already accepted the <a data-toggle="modal" data-bs-toggle="modal" data-url="%url%" href="%url%" title="general terms and conditions">general terms and conditions</a>.',
 ...
 To complete the sign-up process, search your inbox for our confirmation email and click on the link provided with it.',
    ...
    'footer.serviceContactLink' => 'Or via our <a data-bs-toggle="modal" data-toggle="modal" data-bs-toggle="modal" data-url="%url%" href="%url%" title="contact form">contact form</a>.',
    ...
    'footer.includeVat' => '* All prices incl. VAT plus <a data-toggle="modal" data-bs-toggle="modal" href="%url%" data-url="%url%">shipping costs</a> and possible delivery charges, if not stated otherwise.',
    'footer.excludeVat' => '* All prices excl. VAT plus <a data-toggle="modal" data-bs-toggle="modal" href="%url%" data-url="%url%">shipping costs</a> and possible delivery charges, if not stated otherwise.',
