...
(require __DIR__.'/Shopware_Production_KernelProdContainer.php')->set(\ContainerEERBnCL\Shopware_Production_KernelProdContainer::class, null);
...
$classes[] = 'Shopware\Core\Framework\Routing\Subscriber\ActiveRulesDataCollectorSubscriber';
