...
class __TwigTemplate_1c26253ffda0b518b3f80c3957e6d0028653b3b12c86720bb5e1cc02f0a166bc extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_page_checkout_confirm_shipping_inner($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(sw_get_attribute($this->env, $this->source, ($context["page"] ?? null), "shippingMethods", [], "any", false, false, false, 6));
        foreach ($context['_seq'] as $context["_key"] => $context["shipping"]) {
            // line 7
            echo "                ";
            if ((sw_get_attribute($this->env, $this->source, $context["shipping"], "id", [], "any", false, false, false, 7) === sw_get_attribute($this->env, $this->source, sw_get_attribute($this->env, $this->source, ($context["context"] ?? null), "shippingMethod", [], "any", false, false, false, 7), "id", [], "any", false, false, false, 7))) {
                // line 8
                echo "                    ";
...
";
    ...
    public function block_page_checkout_confirm_shipping_title($context, array $blocks = [])
    {
        ...
        echo "                <div class=\"card-title\">
                    ";
        // line 14
        echo $this->extensions['Shopware\Core\Framework\Adapter\Twig\Extension\SwSanitizeTwigFilter']->sanitize($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("checkout.confirmShippingMethod"));
        echo "
                </div>
            ";
    }
    ...
    {
        return new Source("", "@Storefront/storefront/page/checkout/confirm/confirm-shipping.html.twig", "/Applications/MAMP/htdocs/shopware/vendor/shopware/storefront/Resources/views/storefront/page/checkout/confirm/confirm-shipping.html.twig");
    }
}
