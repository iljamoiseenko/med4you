...
class __TwigTemplate_8cda6140caf47bd62d0f5524291606731625122e037448d7bfecc4e7402e349f extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 6
        if ((($context["section"] ?? null) && (0 === twig_compare(sw_get_attribute($this->env, $this->source, ($context["section"] ?? null), "type", [], "any", false, false, false, 6), "sidebar")))) {
            // line 7
            echo "        ";
    ...
    ";
        // line 10
        $context["slot"] = sw_get_attribute($this->env, $this->source, ($context["cmsPage"] ?? null), "firstElementOfType", [0 => "product-listing"], "method", false, false, false, 10);
        // line 11
        echo "
    ";
        // line 12
...
($context["listingColumns"] ?? null)]));
    ...
    {
        return new Source("", "@Storefront/storefront/element/cms-element-product-listing.html.twig", "/Applications/MAMP/htdocs/shopware/vendor/shopware/storefront/Resources/views/storefront/element/cms-element-product-listing.html.twig");
    }
}
